...
import com.monadpad.le.dsp.SampleRate;
...
public class MainActivity extends Activity
{
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putInt("askToUpdateInfo", askToUpdateInfo);
        ...
        if (source != null){
            ...
            savedInstanceState.putInt("galleryId", source.id);
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            askToUpdateInfo = savedInstanceState.getInt("askToUpdateInfo");
            ...
            if (savedInstanceState.getInt("gallerySource") > 0){
                ...
                intentSource.id = savedInstanceState.getInt("galleryId");
    ...
    private class SendJam extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            saved = save.execute(saveUrl, urls[0]);
            desc = save.desc;
        ...
        protected void onPostExecute(String result) {
            ...
            if (saved) {
                ...
                if (jamId.length > 1 && jamId[1].length() > 0 && result.startsWith("good")){
                    ...
                    int id = Integer.parseInt(jamId[1]);
                    shareId(id);
    ...
    private void shareId(int id) {
        String actionSend = Intent.ACTION_SEND;
        Intent shareIntent = new Intent(actionSend);
        shareIntent.setType("text/plain");
        shareIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, getString(R.string.app_name));
        shareIntent.putExtra(android.content.Intent.EXTRA_TEXT, shareUrl + Integer.toString(id));
    ...
    private boolean setupFromIntent(Intent intent){
        ...
        if (Intent.ACTION_VIEW.equals(intent.getAction())) {
            ...
            if (intent.getExtras() != null && intent.getExtras().getString("grooveInfo") != null){
                ...
                intentSource.id = intent.getIntExtra("galleryId", 0);
    ...
    private void share() {
        if (!mJam.isSetup()){
            ...
            if (mJam.getSourceInfo().id > -1) {
                ...
                new SaveToSd(this).execute(grooveInfo);
                new SendJam().execute(grooveInfo);
            }
        }
    }
