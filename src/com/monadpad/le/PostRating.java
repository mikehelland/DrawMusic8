...
public class PostRating {
    ...
    public PostRating(Context context, float rating, int grooveId) {
        ...
        // post the rating
        new PostIt().execute(Float.toString(rating), Integer.toString(grooveId), userId);
...
//            new AuthenticatedRequestTask().execute(url + "/admin");
            ...
            if (result)
                new PostIt().execute(Float.toString(rating), Integer.toString(grooveId), "");
