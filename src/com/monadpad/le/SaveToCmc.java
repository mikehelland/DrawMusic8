...
public class SaveToCmc {
    ...
    public boolean execute(String saveUrl, String data) {
        ...
        try {
            ...
            postParams.add(new BasicNameValuePair("artist", ""));
            postParams.add(new BasicNameValuePair("private", "true"));
    ...
    private class UpdateAsyncTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... urls) {
            ...
            try {
                ...
                List<NameValuePair> postParams = new ArrayList<NameValuePair>();
                postParams.add(new BasicNameValuePair("id", Integer.toString(source.id)));
